...
DEFAULT_CFG = {
    ...
    "autogenerated_claim_code_config": {'code_length': 9},
    "max_claim_length": 20,
    "claim_validation_multiple_services_explanation_required": True,
    "claim_validation_multiple_lab_services_explanation_required": False,
    "autogenerate_func": 'claim.utils.autogenerate_ethiopian_claim_code',
...
class ClaimConfig(AppConfig):
    ...
    claim_validation_multiple_lab_services_explanation_required = None
