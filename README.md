...
* gql_query_claim_review_page_perms: required rights to access the Claim Review page in the frontend (default: `["111080"]`)
* gql_query_claim_approval_page_perms: required rights to access the Claim Approval page in the frontend (default: `["111081"]`)
* gql_query_insuree_checkin_page_perms: required rights to access the Insuree Check-in page in the frontend (default: `["111082"]`)
* gql_query_health_facility_page_perms: required rights to access the Health Facility page in the frontend (default: `["111083"]`)
